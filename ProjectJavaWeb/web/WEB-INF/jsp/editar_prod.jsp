...
<html>
    ...
    <body>
        <form:form method="POST" modelAttribute="tactil" action="EditProd" onsubmit="return ValidacionEditProd()">
            <table class="tablainsert">
                <thead><a href="productos?categoria=99&oferta=1&filtro_nombre="><img style="width: 100px; height: 80px; float: left;" src="IMG/flecha.png"></a><h1 style="text-align: center;">Editar Productos</h1></thead>
                <tr>
                ...
                <tr>
                    ...
                    <td><form:textarea path="descripcion" id="descripcion" name="descripcion" rows="5"  /></td>
                    <td><span id="error_password"> </span></td>
                </tr>
                <tr>
                    <form:input type="hidden" class="form-control" id="categoria" path="categoria"  name="categoria"/>
                    ...
                    <td><form:input class="form-control" path="descuento" id="descuento" name="descuento" /></td>
                               ...
                               <tr>
                    <td><b>Precio:</b></td>
                    <td><form:input class="form-control" id="precio" path="precio" name="precio" /></td>
                    </tr>
                                <tr>
                    <td><b>Cantidad:</b></td>
                    ...
                    <td><b>Bloque:</b></td>
                   <td><select class="form-control" path="num_block" name="num_block"  />
                       ...
                       <%
                         ...
                         for (int i=1; i<=12; i++) {
                               ...
                               if(("Bloc "+i).equals(request.getParameter("num_block"))){
                                   
                                %>
                           <option selected value="Bloc <%=i %>">bloque <%=i %></option>
                       <%
                              }else{
                       %>
                     ...
                     <td><select class="form-control" path="num_passadis" name="num_passadis"   />
                       ...
                       <%
                           ...
                           for (int i=1; i<=12; i++) {
                               ...
                               if(("passadis "+i).equals(request.getParameter("num_passadis"))){
                                   
                                %>
                           <option selected value="passadis <%=i %>">pasillo <%=i %></option>
                       <%
                              }else{
                       %>
                     ...
                     <td><select class="form-control" path="num_lleixa" name="num_lleixa"   />
                       ...
                       <%
                         for (int i=1; i<=8; i++) {
                               ...
                               if(("lleixa "+i).equals(request.getParameter("num_lleixa"))){
                                   
                                %>
                           <option selected value="lleixa <%=i %>">lleixa <%=i %></option>
                       <%
                              }else{
                       %>
